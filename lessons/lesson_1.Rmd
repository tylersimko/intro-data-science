...
2. Create an object called `name` with your name. Now, go in the console and type `?abs` to open the documentation for the `abs()` function. Come up with an example that shows what it does. 
...
2. What happens if you run `prices + 1`? What is this doing?
